...
const styles = StyleSheet.create({
  ...
  primaryBtn: { backgroundColor: COLORS.secondary, paddingVertical: 14, paddingHorizontal: 22, flexDirection: 'row', alignItems: 'center', gap: 10 },
  primaryBtnText: { color: COLORS.primary, fontWeight: '900', fontSize: 10, letterSpacing: 1.5 },
  ...
  avatar: { width: 40, height: 40, borderRadius: 20, borderWidth: 1, borderColor: COLORS.secondary },
  profileInfo: { flex: 1 },
  ...
  regionScroll: { gap: 16 },
  regionCard: { width: 140, padding: 16, backgroundColor: 'rgba(255,255,255,0.02)', borderRadius: 2, borderWidth: 0.5, borderColor: 'rgba(212, 175, 55, 0.1)' },
